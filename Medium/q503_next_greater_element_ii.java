...
class Solution {
    public int[] nextGreaterElements(int[] nums) {
        ...
        // stack stores the indices of previous seen elements that
        // are potentially smaller than current element.
        Stack<Integer> stack = new Stack<>();

        // traverse twice so that the elements after the maximum element
        // are stored in the stack for the second iteration.
        for (int i = 0; i < n * 2; i++) {
            int index = i % n;
